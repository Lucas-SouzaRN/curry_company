...
def order_metric(df1):
    ...
    st.plotly_chart(a, use_container_width=True )     # função do Streamlit  e vai guardar a função do grafico, usa o paramentro use_container_width=True para caber no espaço #
    return a
